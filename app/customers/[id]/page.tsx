        ...
        <div className="flex gap-4 py-3 border-b" style={{ borderColor: 'var(--border)' }}>
          ...
          {customer.address ? (
            <div className="flex items-start gap-2 flex-wrap">
              ...
              <button
                onClick={() => {
                  const url = `https://uri.amap.com/navigation?to=&toname=${encodeURIComponent(customer.name)}&toadd=${encodeURIComponent(customer.address ?? '')}&mode=car&src=xiaoxiangcrm`;
